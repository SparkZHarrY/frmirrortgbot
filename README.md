...
to know how to get them click on the  #[ link ](https://github.com/SparkZHarrY/frmirrortgbot#getting-google-oauth-api-credential-file)
...
- Clone this repo:
```
git clone https://github.com/SparkZHarrY/frmirrortgbot/
cd frmirrortgbot
```
